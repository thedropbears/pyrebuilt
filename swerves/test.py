...
class TunerConstants:
    ...
    _front_left_encoder_offset: units.rotation = 0.35595703125
    _front_left_steer_motor_inverted = True
    _front_left_encoder_inverted = False

    _front_left_x_pos: units.meter = inchesToMeters(9.1929)
    _front_left_y_pos: units.meter = inchesToMeters(9.1929)

    # Front Right
    _front_right_drive_motor_id = 4
    _front_right_steer_motor_id = 8
    _front_right_encoder_id = 2
    _front_right_encoder_offset: units.rotation = -0.020751953125
    _front_right_steer_motor_inverted = True
    _front_right_encoder_inverted = False

    _front_right_x_pos: units.meter = inchesToMeters(9.1929)
    _front_right_y_pos: units.meter = inchesToMeters(-9.1929)

    # Back Left
    _back_left_drive_motor_id = 2
    _back_left_steer_motor_id = 6
    _back_left_encoder_id = 4
    _back_left_encoder_offset: units.rotation = 0.021728515625
    _back_left_steer_motor_inverted = True
    _back_left_encoder_inverted = False

    _back_left_x_pos: units.meter = inchesToMeters(-9.1929)
    _back_left_y_pos: units.meter = inchesToMeters(9.1929)

    # Back Right
    _back_right_drive_motor_id = 3
    _back_right_steer_motor_id = 7
    _back_right_encoder_id = 3
    _back_right_encoder_offset: units.rotation = 0.181640625
    _back_right_steer_motor_inverted = True
    _back_right_encoder_inverted = False

    _back_right_x_pos: units.meter = inchesToMeters(-9.1929)
    _back_right_y_pos: units.meter = inchesToMeters(-9.1929)
